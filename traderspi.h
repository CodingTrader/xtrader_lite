...
public:
	...
	double GetCurOpenCost(const CThostFtdcInvestorPositionField* pInv,int iMul);
	void GetSettPx(const TThostFtdcInstrumentIDType instId,double& dprePx,double& dlastPx);
	int GetLastTdVol(const CThostFtdcInvestorPositionField* pInv,int& iTd,TThostFtdcOffsetFlagType& cFlag);
